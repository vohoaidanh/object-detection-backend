...
if __name__ == '__main__':
    ...
    if not os.path.isfile(os.path.join(original_path, 'label.txt')):
        print('Missing label.txt file.', original_path)
        exit(1)
    ...
    for i in tqdm(range(len(aa.imgs_path))):
        ...
        save_img_path = os.path.join(save_path,'images/train', base_img)
        save_txt_path = os.path.join(save_path,'labels/train', base_txt)
...
#python train2yolo.py D:/datasets/original-widerface D:/datasets/widerface
