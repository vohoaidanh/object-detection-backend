    ...
    with open('{}/{}/label.txt'.format(root, phase), 'r') as f:
        ...
        for line in tqdm(lines):
            ...
            if '#' in line:
                ...
                label = '80 {} {} {} {}'.format(round(box[0], 4), round(box[1], 4),
...
if __name__ == '__main__':
    ...
    for idx, data in enumerate(datas.keys()):
        ...
        out_img = f'{save_path}/images/val/{idx}.jpg'
        out_txt = f'{save_path}/labels/val/{idx}.txt'
...
#python val2yolo.py D:/datasets/original-widerface/val D:/datasets//widerface/val
